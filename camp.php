                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="py-2 mb-3">
                                ...
                                <h2>營地類型: <span class="badge bg-success"><?= $Campcate1Arr[$row["campCate1ID"]] ?></span>
                            ...
                            <div class="mb-3">價格$ <?= $row["campPrice"] ?></div>
                            <h4>營地位置:</h4>
                            <div class="mb-3">
                            ...
                            <div> <a  href="camp-list.php" class="btn btn-primary">返回</a></div>
