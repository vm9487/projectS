...
//--------------------新的篩選2--------------------
//$param['search'] = $param['search1'] = !empty($_GET['search']) ? "%".$_GET['search']."%" : null;
//$param['minPrice'] = $param['minPrice1']  = !empty($_GET['minPrice'])  ? $_GET['minPrice']  : null;
//$param['maxPrice'] = $param['maxPrice1']  = !empty($_GET['maxPrice'])  ? $_GET['maxPrice']  : null;
//$param['cate1'] = $param['cate11']  = !empty($_GET['cate1'])  ? $_GET['cate1']  : null;
//$param['county'] = $param['county1']  = !empty($_GET['county'])  ? $_GET['county']  : null;
//$param['cate3'] = $param['cate31']  = !empty($_GET['cate3'])  ? $_GET['cate3']  : null;
//
//$sqlFilter2 = "SELECT * FROM users
//WHERE (search LIKE :search or :search1 is null)
//AND   (minPrice  = :minPrice  or :minPrice1  is null)
//AND   (maxPrice  != :maxPrice  or :maxPrice1  is null)
//AND   (cate1  != :cate1  or :cate11  is null)
//AND   (county  != :county  or :county1  is null)
//AND   (cate3  != :cate3  or :cate31  is null)";
//
//$stmtFilter2 = $db_host->prepare($sqlFilter2);
//$stmtFilter2->execute($param);
//$row = $stmtFilter2->fetchAll(PDO::FETCH_ASSOC);
